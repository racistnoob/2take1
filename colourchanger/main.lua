--[[if not menu.is_trusted_mode_enabled(1 << 3) then
    menu.notify("Http trusted mode required (Auto-Updater)", "Vehicle Colour Changer")
end
if not menu.is_trusted_mode_enabled(1 << 2) then
    menu.notify("Natives trusted mode required (Color Changing Natives)", "Vehicle Colour Changer")
end
